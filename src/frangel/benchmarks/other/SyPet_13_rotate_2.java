...
public enum SyPet_13_rotate_2 implements TaskCreator {
    INSTANCE;
    static {
    ...
    public SynthesisTask createTask() {
        SynthesisTask task = new SynthesisTask()
                .setName("sypet_13_rotate_2")
                .setInputTypes(Area.class, Point2D.class, double.class)
                .setInputNames("area", "p", "angle")
        ...
        task.addExample(new Example()
                .setInputs(() -> new Object[] { new Area(new Rectangle2D.Double(10, 20, 10, 2)), new Point2D.Double(0, 20), Math.PI / 2 })
                .setOutput(new Area(new Rectangle2D.Double(-2, 30, 2, 10))));

        task.addExample(new Example()
                .setInputs(() -> new Object[] { new Area(new Rectangle2D.Double(10, 20, 10, 2)), new Point2D.Double(10, 0), Math.PI / 2 })
                .setOutput(new Area(new Rectangle2D.Double(-12, 0, 2, 10))));
